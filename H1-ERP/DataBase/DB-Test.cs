...
namespace H1_ERP.DataBase
{
    ...
    {
        /// <summary>
        /// Inserts the specified amount of rows into all rows of the database with random data
        /// </summary>
        /// <param name="amountToAdd">The amount of rows to be inserted</param>
        public void BulkAddData(int amountToAdd)
        {
            ...
            {
                // Inserts data in the correct order so there are no conflicts with foreign keys
        ...
        {
            // Copy pasted from ssms so looks like a mess
        ...
        /// <summary>
        /// Deletes all data in the database and adds new data
        /// </summary>
        /// <param name="amountToAdd">The amount of rows of data to add</param>
